...
- **Graphical insights** – A combined bar/line chart (powered by Chart.js)
  compares corporate tax, operating cost indices, and foundation friendliness
  for the leanest 12 jurisdictions in the dataset.
...
That archive mirrors the flat-file layout that powers the dashboard.
